...
export default function Order({ menus, menuCategories }: Props) {
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-4 h-full max-h-[650px] sm:max-h-[calc(100vh-118px)] sm:col-span-3 lg:col-span-4">
        <OrderMenu setModalType={setCartModalType} toggleModal={toggleCartModal} menus={menus} menuCategories={menuCategories} />
      </div>
