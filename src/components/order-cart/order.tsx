...
export default function Order({ menus, menuTypes }: Props) {
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-4 h-full max-h-[650px] sm:max-h-[calc(100vh-118px)] sm:col-span-3 lg:col-span-4">
        <OrderMenu setModalType={setCartModalType} toggleModal={toggleCartModal} menus={menus} menuTypes={menuTypes} />
      </div>
