...
const LabelHour = forwardRef<HTMLSelectElement, Props>(({ className, label, name, isError, isImportant, ...props }, ref) => {
  return (
...
LabelHour.displayName = 'LabelHour';

export default LabelHour;
