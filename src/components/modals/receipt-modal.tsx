...
export default function ReceiptModal({ isOpen, closeModal }: Props) {
  ...
  return (
    <ModalWrapper isOpen={isOpen} closeModal={closeModal}>
      <div className="p-3 min-w-[300px] w-full max-w-[500px] bg-white rounded-sm">
        ...
        <div className="text-center text-sm font-semibold text-gray-500 my-2">Masukkan detil pembayaran</div>
